...
def movieLookupType(mykey, searchstring, typestring):
    try:
    ...
    while True:
        ...
        if answer in ["1", "2"]:
            ...
            if answer == "1":
                ...
                typestring =   input("Entertainment type? Valid options include 'movie', 'series', 'episode':\n> ")
                resp = movieLookupType(mykey, searchstring, typestring)
            if resp:
                # display the results
